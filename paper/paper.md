...
![NeuroCluster workflow. This approach involves three key steps: (1) determine cluster statistic in true data, (2) generate a null distribution of cluster statistics by permuting dataset, (3) determine significance of true cluster statistic against null distribution.](https://github.com/aliefink/NeuroCluster/blob/main/workflow/Figure1_workflow.png){#fig:Fig1}
...
![NeuroCluster validation in synthetic data. A. Time-frequency representation (TFR) showing power differences between high (>0.50) and low (<0.50) expected value trials in synthetic data (1 channel, 100 trials, time-locked to "choice"). B. A significant positive cluster identified in the expected time-frequency region, consistent with the predefined association embedded in the synthetic dataset.](https://github.com/aliefink/NeuroCluster/blob/main/workflow/Figure3.png){#fig:Fig3}
